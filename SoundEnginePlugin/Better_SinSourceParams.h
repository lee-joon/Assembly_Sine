...
#ifndef Better_SinSourceParams_H
#define Better_SinSourceParams_H
...
struct Better_SinRTPCParams
{
    AkReal32 fDuration;
};

struct Better_SinNonRTPCParams
{
};

struct Better_SinSourceParams
    : public AK::IAkPluginParam
{
    Better_SinSourceParams();
    Better_SinSourceParams(const Better_SinSourceParams& in_rParams);
    ...
    Better_SinRTPCParams RTPC;
    Better_SinNonRTPCParams NonRTPC;
};

#endif // Better_SinSourceParams_H
