...
#ifndef Better_SinSource_H
#define Better_SinSource_H
...
private:
    Better_SinSourceParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkSourcePluginContext* m_pContext;
    AkFXDurationHandler m_durationHandler;

    AkReal32 Hz = 0.0f;
    AkUInt32 BufferSize = 0;
    AkUInt64 StepPoint = 0;
};

#endif // Better_SinSource_H
